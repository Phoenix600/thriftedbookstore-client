...
import 'package:thriftedbookstore/features/search/services/search_services.dart';
import 'package:thriftedbookstore/features/search/widgets/search_products.dart';
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //   ),
      // ),
      appBar: commonAppBar("Your", " Results", size),
      body: products == null
          ? const Loader()
          : Column(
              children: [
